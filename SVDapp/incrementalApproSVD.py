...
def incrementalApproSVD(matrixB1, matrixB2, c1, c2, k, p1, p2):
    """Apply Incremental ApproSVD for a matrix with new columns

  :param matrixB1: original matrix (m x n1)
  :param matrixB2: new columns (m x n2)
  ...
  """
    ...
    return incrementalSVD(matrixC1, matrixC2, k, True)
